 ...
 * Epics
 */
const createUserWithEmailPassword = (action$: Observable<Action>, state: any) =>
  action$.pipe(
...
const logout = (action$: Observable<Action>, state: any) =>
  action$.pipe(
...
const signInUserWithGoogle = (action$: Observable<Action>, state: any) =>
  action$.pipe(
