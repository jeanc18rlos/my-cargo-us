...
import { Components, Utils, Config } from '../../../../';

const {
  ThemeSettings: { NAV_STYLE_NO_HEADER_EXPANDED_SIDEBAR, NAV_STYLE_NO_HEADER_MINI_SIDEBAR, THEME_TYPE_LITE }
} = Config;
const { CustomScrollbars, IntlMessages } = Utils;
const {
  Atoms: { Link }
} = Components;
...
const SidebarContent = ({ sidebarCollapsed, setSidebarCollapsed, navStyle, themeType }: any) => {
    ...
    <>
      ...
      <div className="gx-sidebar-content">
        ...
        <CustomScrollbars className="gx-layout-sider-scrollbar">
          <Menu theme={themeType === THEME_TYPE_LITE ? 'lite' : 'dark'} mode="inline">
