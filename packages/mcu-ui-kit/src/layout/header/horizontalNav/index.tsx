...
const HorizontalNav = () => {
  return (
    <Menu style={{ width: '100%' }} mode="horizontal">
      <SubMenu popupClassName={'gx-menu-horizontal'} key="main" title={<IntlMessages id="sidebar.main" />}>
        <SubMenu
      ...
      <SubMenu popupClassName={'gx-menu-horizontal'} key="components" title={<IntlMessages id="sidebar.components" />}>
        <SubMenu
          popupClassName="gx-menu-horizontal"
          key="general"
          title={
      ...
      <SubMenu popupClassName={'gx-menu-horizontal'} key="extensions" title={<IntlMessages id="sidebar.extensions" />}>
