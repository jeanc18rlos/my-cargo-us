...
const theme = {
  ...
  'screen-md-max': `${breakpoints.md - 1}px`,
  'screen-xl-min': `${breakpoints.xl}px`,
  'screen-xxxl-min': `${breakpoints.xxxl}px`
};
...
body {
  ...
  &.framed-layout {
    padding: ${theme['framed-layout-base']};
  ...
  &.boxed-layout {
    background-color: ${theme['primary-color']};
    max-width: ${theme['screen-xl-min']} + 80px;
    margin: 0 auto;
    .box-shadow(@gx-card-shadow);

    @media screen and (min-width: ${theme['screen-xxxl-min']}) {
      max-width: ${theme['screen-xl-min']} + 300px;
    }
  }
...
.@{class-prefix}-social-link {
  ...
  & li .anticon {
    ...
    text-align: center;
    color: ${theme['primary-color']};
    border: @border-style-base @border-width-base ${theme['primary-color']};
...
@media (min-width: ${theme['screen-xl-min']}) {
